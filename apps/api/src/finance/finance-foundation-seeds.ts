...
export const FINANCE_BASE_ACCOUNT_SEEDS: readonly FinanceAccountSeed[] = [
  ...
  { code: 'PAY-002', systemKey: 'EOS_PAYABLE', nameAr: 'مستحقات نهاية الخدمة', nameEn: 'End-of-service payable', type: FinanceAccountType.LIABILITY },
  ...
  { code: 'EXP-004', systemKey: 'PAYROLL_EXPENSE', nameAr: 'رواتب وخدمات الموظفين', nameEn: 'Payroll and employee services', type: FinanceAccountType.EXPENSE },
  { code: 'EXP-009', systemKey: 'EOS_EXPENSE', nameAr: 'مكافأة نهاية الخدمة', nameEn: 'End-of-service expense', type: FinanceAccountType.EXPENSE },
...
export const FINANCE_BASE_CATEGORY_SEEDS: readonly FinanceCategorySeed[] = [
  ...
  { code: 'EXP-004', accountCode: 'EXP-004', nameAr: 'رواتب وخدمات الموظفين', nameEn: 'Payroll and employee services', kind: FinanceCategoryKind.EXPENSE, sortOrder: 80 },
...
export const FINANCE_BASE_CATEGORY_HIERARCHY_SEEDS: readonly FinanceCategoryHierarchySeed[] = [
  ...
  { code: 'E2-8', parentCode: 'EXP-002', nameAr: 'رسوم منصات حكومية', nameEn: 'Government platform fees', kind: FinanceCategoryKind.EXPENSE, sortOrder: 80 },
  { code: 'E2-9', parentCode: 'EXP-002', nameAr: 'شهادات صحية وتصاريح موظفين', nameEn: 'Health certificates and employee permits', kind: FinanceCategoryKind.EXPENSE, sortOrder: 90 },
  { code: 'E2-10', parentCode: 'EXP-002', nameAr: 'التأمينات الاجتماعية', nameEn: 'GOSI employer contributions', kind: FinanceCategoryKind.EXPENSE, sortOrder: 100 },
  ...
  { code: 'E4-2', parentCode: 'EXP-004', nameAr: 'تأمين طبي', nameEn: 'Medical insurance', kind: FinanceCategoryKind.EXPENSE, sortOrder: 20 },
  { code: 'E4-3', parentCode: 'EXP-004', nameAr: 'تدريب وتطوير', nameEn: 'Training and development', kind: FinanceCategoryKind.EXPENSE, sortOrder: 30 },
  ...
  { code: 'E6-3', parentCode: 'EXP-006', nameAr: 'رسوم تطبيقات', nameEn: 'App platform fees', kind: FinanceCategoryKind.EXPENSE, sortOrder: 30 },
  { code: 'E6-4', parentCode: 'EXP-006', nameAr: 'رسوم ترويج في التطبيقات', nameEn: 'In-app promotion fees', kind: FinanceCategoryKind.EXPENSE, sortOrder: 40 },
...
export const STANDARD_SUPPLIER_SEEDS: readonly StandardSupplierSeed[] = [
  ...
  { key: "GOSI", nameAr: "المؤسسة العامة للتأمينات الاجتماعية", nameEn: "General Organization for Social Insurance", categoryCode: "E2-10" },
  ...
  { key: "HRSD", nameAr: "وزارة الموارد البشرية والتنمية الاجتماعية", nameEn: "Ministry of Human Resources and Social Development", categoryCode: "E2-8" },
  ...
  { key: "QIWA", nameAr: "قوى", nameEn: "Qiwa", categoryCode: "E2-8" },
  { key: "ABSHER_BUSINESS", nameAr: "أبشر أعمال", nameEn: "Absher Business", categoryCode: "E2-8" },
  ...
  { key: "AJEER", nameAr: "أجير", nameEn: "Ajeer", categoryCode: "E2-8" },
  { key: "MUSANED", nameAr: "مساند", nameEn: "Musaned", categoryCode: "E2-8" },
  { key: "WAFID", nameAr: "وافد", nameEn: "Wafid", categoryCode: "E2-9" },
