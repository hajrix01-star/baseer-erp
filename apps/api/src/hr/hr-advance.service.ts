...
import type { IssueHrEmployeeAdvanceRequest } from '@baseer-erp/contracts';
...
import { FinanceAccountStatus, FinanceAccountType, FinanceVaultPaymentMethod, HrEmployeeFinancialMovementType, HrEmployeeStatus, Prisma } from '../generated/prisma/client.js';
...
export class HrAdvanceService {
  ...
  private async resolveAllocations(tx: Prisma.TransactionClient, context: TrustedCompanyActorContext, input: ReturnType<typeof normalize>) {
