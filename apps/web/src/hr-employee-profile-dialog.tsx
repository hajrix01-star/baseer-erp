...
type HrEmployeeProfileProps = { detail: HrDetail; language: Language; onClose: () => void; onEdit: () => void; onManageCompensation: () => void; onLoadMoreMovements: () => Promise<void>; onError: (message: string) => void; onChanged: () => Promise<void>; };
