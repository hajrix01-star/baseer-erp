...
export function HrLeaveWorkspace({ language, stage }: { language: Language; stage?: string | null }) {
  ...
  return <section className="administration-panel">
    ...
    <Suspense fallback={null}><LazyHrLeaveCreateDialog open={createOpen} language={language} busy={busy} employees={employees} remoteSearch={searchEmployeeOptions} onClose={() => setCreateOpen(false)} onSubmit={saveLeave} /></Suspense>
