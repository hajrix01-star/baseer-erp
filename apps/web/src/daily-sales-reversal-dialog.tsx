...
export function DailySalesReversalDialog({
  ...
  const cancellation = language === "ar" ? { title: "\u062a\u0623\u0643\u064a\u062f \u0625\u0644\u063a\u0627\u0621 \u0627\u0644\u062a\u0642\u0641\u064a\u0644", intro: "\u064a\u064f\u0644\u063a\u064a \u0627\u0644\u0646\u0638\u0627\u0645 \u0627\u0644\u0623\u062b\u0631 \u0627\u0644\u0645\u062d\u0627\u0633\u0628\u064a \u0628\u0642\u064a\u062f \u0645\u0642\u0627\u0628\u0644 \u0645\u0648\u062b\u0642\u060c \u0648\u0644\u0627 \u064a\u062d\u0630\u0641 \u0627\u0644\u0633\u062c\u0644 \u0627\u0644\u0623\u0635\u0644\u064a.", record: "\u0627\u0644\u0633\u062c\u0644 \u0627\u0644\u0645\u0631\u0627\u062f \u0625\u0644\u063a\u0627\u0624\u0647", reason: "\u0633\u0628\u0628 \u0627\u0644\u0625\u0644\u063a\u0627\u0621", confirm: "\u062a\u0623\u0643\u064a\u062f \u0627\u0644\u0625\u0644\u063a\u0627\u0621", hint: "\u0627\u0644\u0625\u0644\u063a\u0627\u0621 \u0644\u0627 \u064a\u062d\u0630\u0641 \u0627\u0644\u0633\u062c\u0644\u061b \u064a\u0646\u0634\u0626 \u0642\u064a\u062f\u064b\u0627 \u0645\u0642\u0627\u0628\u0644\u064b\u0627 \u0645\u0648\u062b\u0642\u064b\u0627." } : { title: "Confirm closing cancellation", intro: "Cancellation creates a documented offsetting journal; the original record is never deleted.", record: "Record to cancel", reason: "Cancellation reason", confirm: "Confirm cancellation", hint: "Cancellation preserves history and creates a documented offsetting journal." };
    ...
    <div className="daily-sales-dialog-backdrop" role="presentation" onMouseDown={close}>
      <section ref={dialogRef} className="daily-sales-dialog daily-sales-reversal-dialog" role="dialog" aria-modal="true" aria-labelledby="daily-sales-reversal-title" onMouseDown={(event) => event.stopPropagation()}>
        ...
        <div className="daily-sales-reversal-dialog__summary">
          ...
          <span>{closing.businessDate.slice(0, 10)} Â· {closing.grossAmount} SAR</span>
        </div>
        ...
        <footer className="daily-sales-dialog__actions">
          ...
          <button className="daily-sales-danger" type="button" onClick={onConfirm} disabled={saving || !valid}>{saving ? copy.saving : cancellation.confirm}</button>
        </footer>
      </section>
    </div>
  );
