    ...
    {activeTab === "reports" ? <BaseerCard className={`hr-attendance__employee-report-picker${reportEmployeeId !== "ALL" ? " is-selected" : ""}`}>
      <div className="hr-attendance__card-header">
        <div>
          ...
          <p>{ar ? "اختر موظفاً لإظهار خطة دوامه، الوقت الفعلي، الالتزام والاستثناءات. لا يغيّر التقرير الراتب أو السجل." : "Choose an employee to see their plan, actual time, commitment and exceptions. The report never changes payroll or attendance records."}</p>
        </div>
      </div>
