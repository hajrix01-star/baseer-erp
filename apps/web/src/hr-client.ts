...
export type HrCompensationProfile = { id: string; employeeId: string; effectiveFrom: string; effectiveTo: string | null; monthlyGross: string; compensationMethod: HrCompensationMethod; foodAllowance: string; otherAllowance: string; scheduledHoursPerDay: number | null; scheduledWorkDays: number | null; notes: string | null };
