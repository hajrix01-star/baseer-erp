...
type Movement = { id: string; source: MovementSource; sourceType: string; documentNumber: string; displayLabelAr: string; displayLabelEn: string; businessDate: string; supplierInvoiceDate: string | null; kind: InvoiceKind; settlementKind: "PAID" | "PAYABLE" | null; status: InvoiceStatus; supplier: Option | null; category: Option | null; grossAmount: string; netAmount: string; vatAmount: string; journalEntryId: string; batchNumber: string | null; notes: string | null; recurring: boolean; createdAt: string };
