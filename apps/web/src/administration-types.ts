...
export type AdministrationOverview = {
  ...
  users: Array<{ id: string; login: string; nameAr: string; nameEn: string; avatarKind: "INITIALS" | "MALE" | "FEMALE"; status: "ACTIVE" | "DISABLED"; memberships: AdministrationMembership[] }>;
