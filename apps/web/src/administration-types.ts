...
export type AdministrationOverview = {
  ...
  permissions: Array<{ code: string; module: string; moduleAr: string; moduleEn: string; sectionAr: string; sectionEn: string; nameAr: string; nameEn: string; risk: "standard" | "sensitive"; requires: string[] }>;
};
