...
export function TreasuryWorkspaceRuntime({ language }: { language: Language }) {
        ...
        >
          ...
          <label>
            ...
            <BaseerCombobox
              ...
              invalid={Boolean(errors.toVaultId)}
              placeholder={text.selectVault}
              options={activeVaults.filter((vault) => vault.id !== transfer.fromVaultId).map((vault) => ({ id: vault.id, label: displayName(language, vault) }))}
              onChange={(toVaultId) => setTransfer((value) => ({ ...value, toVaultId }))}
            />
            {errors.toVaultId ? (
              <span role="alert">
      ...
      >
        ...
        >
          ...
          <label>
            ...
            <BaseerStaticSelect label={text.selectControlKind}
              value={control.kind}
              onChange={(event) => {
          ...
          <label>
            ...
            <BaseerCombobox
              ...
              invalid={Boolean(errors.vaultId)}
              placeholder={text.selectVault}
              options={activeVaults.filter((vault) => control.kind === "BANK_RECONCILIATION" ? vault.type === "BANK" : vault.type === "CASH").map((vault) => ({ id: vault.id, label: displayName(language, vault) }))}
              onChange={(vaultId) => setControl((value) => ({ ...value, vaultId }))}
            />
            {errors.vaultId ? (
              <span role="alert">
          ...
          <label>
            ...
            <BaseerTextArea
              value={control.notes}
              onValueChange={(notes) => setControl((value) => ({ ...value, notes }))}
            />
          </label>
          </>}
        </BaseerValidatedFormField>
        ...
        >
          ...
          <label>
            ...
            <BaseerTextArea
              ...
              onValueChange={setTransferReversalReason}
            />
            {errors.reason ? (
              <span role="alert">
