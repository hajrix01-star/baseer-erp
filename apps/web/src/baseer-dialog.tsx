...
type Props = { open: boolean; title: string; children: ReactNode; language: BaseerLanguage; busy?: boolean; error?: string | null; reserveErrorSpace?: boolean; onClose: () => void; footer?: ReactNode; size?: "default" | "wide"; className?: string };

/** Central modal shell for forms and read-only details. Uses the shared focus trap and close convention. */
export function BaseerDialog({ open, title, children, language, busy = false, error, reserveErrorSpace = false, onClose, footer, size = "default", className }: Props) {
