...
type AnalyticsPeriod = Readonly<{
  ...
  display: { salesGrossAmount: string | null; applicationSalesGrossAmount: string | null; otherOfficialSalesGrossAmount: string | null; dailyAverageSalesAmount: string | null; recordedCustomerCount: string | null; dailyAverageCustomerCount: string | null; applicationSalesSharePercent: string | null; applicationSalesSharePlotValue: number | null; salesGrossPlotValue: number | null; applicationSalesGrossPlotValue: number | null; otherOfficialSalesGrossPlotValue: number | null };
}>;
