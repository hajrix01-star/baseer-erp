...
export function HrEmployeeLettersPanel({ employeeId, language, onError, onChanged }: { employeeId: string; language: Language; onError: (message: string) => void; onChanged: () => Promise<void> }) {
