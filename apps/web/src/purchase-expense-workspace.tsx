          ...
          >
            ...
            <label>
              ...
              <select
                ...
                onChange={(event) =>
                  updateAmendment("categoryId", event.target.value)
                }
              >
                <option value="">{text.selectCategory}</option>
                {categories
                  .filter((category) => category.kind === amendmentRow.kind)
                  .map((category) => (
            ...
            <label>
              ...
              <select
                ...
                onChange={(event) =>
                  updateAmendment("supplierId", event.target.value)
                }
              >
                <option value="">
                  {language === "ar" ? "بدون مورد" : "No supplier"}
                </option>
            ...
            {amendmentRow.settlementKind === "PAID" ? (
              <label>
                ...
                <select
                  ...
                  onChange={(event) =>
                    updateAmendment("vaultId", event.target.value)
                  }
                >
                  <option value="">
                    {language === "ar" ? "اختر الخزينة" : "Choose a vault"}
                  </option>
