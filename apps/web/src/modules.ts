...
export const modules: readonly ModuleDefinition[] = [
  ...
  { id: 'finance', accent: '#a3532e', accentAlt: '#ec8851', title: { ar: 'المالية والمحاسبة', en: 'Finance & accounting' }, sections: { ar: ['إعدادات المالية', 'الفواتير والمدفوعات', 'الخزائن والبنوك', 'الحسابات والسجل', 'الفئات والتصنيفات'], en: ['Finance setup', 'Invoices & payments', 'Treasury & banks', 'Accounts & ledger', 'Categories & classifications'] } },
