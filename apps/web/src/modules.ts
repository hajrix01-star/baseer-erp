...
export const modules: readonly ModuleDefinition[] = [
  ...
  { id: 'decision', accent: '#3d6f8e', accentAlt: '#64b8c8', title: { ar: 'مركز القرار والسياق', en: 'Decision & context center' }, launcherTitle: { ar: 'مركز القرار', en: 'Decision center' } },
  { id: 'marketing', accent: '#a35b2e', accentAlt: '#e6a64f', title: { ar: 'الأداء التسويقي والسمعة', en: 'Marketing performance & reputation' }, launcherTitle: { ar: 'التسويق والسمعة', en: 'Marketing & reputation' } },
  ...
  { id: 'finance', accent: '#a3532e', accentAlt: '#ec8851', title: { ar: 'المالية والمحاسبة', en: 'Finance & accounting' }, launcherTitle: { ar: 'المالية', en: 'Finance' } },
