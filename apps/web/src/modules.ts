...
export const modules: readonly ModuleDefinition[] = [
  ...
  { id: 'marketing', accent: '#a35b2e', accentAlt: '#e6a64f', title: { ar: 'الأداء التسويقي والسمعة', en: 'Marketing performance & reputation' }, sections: { ar: ['النظرة', 'سجل الحملات', 'السمعة وGoogle', 'المصادر والسياسات'], en: ['Overview', 'Campaign register', 'Reputation & Google', 'Sources & policies'] } },
