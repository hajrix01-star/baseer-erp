...
export const modules: readonly ModuleDefinition[] = [
  ...
  { id: 'finance', accent: '#a3532e', accentAlt: '#ec8851', title: { ar: 'المالية والمحاسبة', en: 'Finance & accounting' }, sections: { ar: ['إعدادات المالية', 'السجل المالي الموحد', 'الخزائن والبنوك', 'الحسابات والسجل', 'الفئات والتصنيفات'], en: ['Finance setup', 'Unified financial register', 'Treasury & banks', 'Accounts & ledger', 'Categories & classifications'] } },
  { id: 'hr', accent: '#a84c84', accentAlt: '#f0a33c', title: { ar: 'الموارد البشرية', en: 'Human resources' }, sections: { ar: ['نظرة HR', 'الموظفون', 'الإجازات والعودة', 'الرواتب', 'السلف والخصومات', 'الإقامات والخدمات', 'نهاية الخدمة', 'أدوات الراتب'], en: ['HR overview', 'Employees', 'Leave & return', 'Payroll', 'Advances & deductions', 'Residencies & services', 'End of service', 'Salary tools'] } },
