...
export const modules: readonly ModuleDefinition[] = [
  ...
  { id: 'finance', icon: '▣', accent: '#a3532e', title: { ar: 'المالية والمحاسبة', en: 'Finance & accounting' }, description: { ar: 'الفواتير والخزائن والمصروفات.', en: 'Invoices, treasury, and expenses.' }, sections: { ar: ['إعدادات المالية', 'الفواتير والمدفوعات', 'الخزائن والبنوك', 'المصروفات', 'الالتزامات والقروض', 'الحسابات والسجل'], en: ['Finance setup', 'Invoices & payments', 'Treasury & banks', 'Expenses', 'Liabilities & loans', 'Accounts & ledger'] } },
