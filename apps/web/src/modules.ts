...
export const modules: readonly ModuleDefinition[] = [
  { id: 'command', accent: '#08744d', accentAlt: '#35c69a', title: { ar: 'مركز القيادة', en: 'Command center' }, sections: { ar: ['لوحة المال والتسويق', 'التقويم', 'التحليلات', 'دفتر المالك اليومي'], en: ['Money and marketing', 'Calendar', 'Analytics', 'Owner daily notebook'] } },
  ...
  { id: 'inbound-evidence', accent: '#526d87', accentAlt: '#7fc3c8', title: { ar: 'البريد والأدلة', en: 'Mail & evidence' }, sections: { ar: ['النظرة', 'Labels وقواعد الفرز', 'مصادر الربط'], en: ['Overview', 'Labels & routing rules', 'Connection sources'] } },
  ...
  { id: 'administration', accent: '#536b63', accentAlt: '#f0b54e', title: { ar: 'الإدارة', en: 'Administration' }, sections: { ar: ['نظرة الإدارة', 'الشركات', 'المستخدمون', 'الأدوار والصلاحيات', 'الهوية والثيم وبصيرة', 'النسخ الاحتياطي'], en: ['Administration overview', 'Companies', 'Users', 'Roles & permissions', 'Identity, theme & Basira', 'Backup'] } },
];
