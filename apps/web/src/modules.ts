...
export const modules: readonly ModuleDefinition[] = [
  ...
  { id: 'hr', accent: '#a84c84', accentAlt: '#f0a33c', title: { ar: 'الموارد البشرية', en: 'Human resources' }, sections: { ar: ['نظرة HR', 'الموظفون', 'الإجازات والعودة', 'الرواتب', 'السلف والخصومات', 'الإقامات والخدمات', 'نهاية الخدمة'], en: ['HR overview', 'Employees', 'Leave & return', 'Payroll', 'Advances & deductions', 'Residencies & services', 'End of service'] } },
