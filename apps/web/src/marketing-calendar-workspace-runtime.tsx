...
function MarketingCalendarWorkspace({ language, session }: { language: MarketingLanguage; session: ActiveSession }) {
  ...
  const ar = marketingIsArabic(language);
  const copy = ar ? {
    title: "التقويم التسويقي", description: "خط زمني يومي للمبيعات الرسمية، المصروفات المثبتة المرتبطة، الحملات والسياق المنشور. السياق يفسر التزامناً ولا يثبت سبباً.", error: "تعذر تحميل التقويم", officialSales: "صافي المبيعات الرسمي", postedSpend: "المصروف المرتبط المثبت", campaigns: "الحملات في الفترة", salesQuality: "جودة المبيعات", chartLoading: "جارٍ تحميل الرسم التفاعلي…", chartTitle: "الحملات والمبيعات والمصروفات حسب اليوم", boundaryTitle: "حدود القراءة", boundary: "لا يلوّن الرسم اليوم الناقص أو الجزئي كمبيعات صفرية. المصروف هنا هو فقط المستندات المالية المثبتة المرتبطة بحملة، ولا يشمل Google Ads قبل ربطه واعتماده.",
  } : {
    title: "Marketing calendar", description: "A daily timeline of official sales, posted linked spend, campaigns, and published context. Context explains timing; it never proves cause.", error: "Calendar could not be loaded", officialSales: "Official net sales", postedSpend: "Posted linked spend", campaigns: "Campaigns in period", salesQuality: "Sales data quality", chartLoading: "Loading the interactive chart…", chartTitle: "Daily campaigns, sales, and spend", boundaryTitle: "Read boundary", boundary: "A missing or partial day is not coloured as zero sales. Spend here is only posted Finance documents linked to a campaign; it excludes Google Ads until an approved connection exists.",
  };
