...
const legalCopy: Readonly<Record<PublicLegalDocument, Readonly<Record<Language, LegalCopy>>>> = {
  privacy: {
    ar: {
      ...
      draftNotice: "هذه نسخة تشغيلية عامة قيد الاعتماد القانوني. ستضاف قناة الدعم الرسمية قبل النشر النهائي وطلب تحقق Google.",
      languageLabel: "اللغة",
      ...
      sections: [
        ...
        { title: "التحكم والحقوق", paragraphs: ["يمكن لمالك الشركة فصل التكامل وإيقافه. عند الفصل يوقف Baseer استخدام التفويض وفق مسار الإبطال المعتمد. ستنشر قناة الدعم والجهة المسؤولة عن طلبات الخصوصية قبل الإطلاق العام."] },
      ],
    },
    en: {
      ...
      draftNotice: "This is a public operating draft pending legal approval. An approved support channel will be added before final publication and Google verification.",
      ...
      sections: [
        ...
        { title: "Control and rights", paragraphs: ["A company owner can disconnect and stop an integration. Once disconnected, Baseer stops using the authorization through its approved revocation path. An approved support channel and responsible contact for privacy requests will be published before general release."] },
      ],
    },
  },
  terms: {
    ar: {
      ...
      updated: "آخر تحديث: 5 سبتمبر 2026",
      draftNotice: "هذه نسخة تشغيلية عامة قيد الاعتماد القانوني. ستضاف جهة الدعم وشروط الجهة المالكة النهائية قبل النشر وطلب تحقق Google.",
      languageLabel: "اللغة",
      switchLanguage: "English",
      ...
      sections: [
        ...
        { title: "التغييرات والتواصل", paragraphs: ["يسجل Baseer التغييرات الجوهرية في هذه الوثيقة قبل سريانها. ستنشر جهة الدعم الرسمية ومسار التواصل بشأن الشروط قبل الإطلاق العام."] },
      ],
    },
    en: {
      ...
      updated: "Last updated: 5 September 2026",
      draftNotice: "This is a public operating draft pending legal approval. The final owner terms and approved support contact will be added before publication and Google verification.",
      languageLabel: "Language",
      switchLanguage: "العربية",
      ...
      sections: [
        ...
        { title: "Changes and contact", paragraphs: ["Baseer records material changes to this document before they take effect. An official support contact and terms channel will be published before general release."] },
      ],
    },
  },
};
