...
export const appCopy = defineLocalizedCopy({
  ar: {
    ...
    paletteCalmGreen: "أخضر هادئ",
    paletteEditorialCopper: "نحاسي دافئ",
    paletteModernAdmin: "إداري حديث",
  ...
  en: {
    ...
    paletteCalmGreen: "Calm green",
    paletteEditorialCopper: "Warm copper",
    paletteModernAdmin: "Modern admin",
