...
export const pageRegistry = [
  ...
  page({ id: "finance-ledger", moduleId: "finance", legacySection: 1, title: { ar: "السجل المالي الموحد", en: "Unified financial register" }, icon: "receipt", navigation: { order: 10, visible: true }, requiredPermissions: any(["finance.ledger.read"]) }),
