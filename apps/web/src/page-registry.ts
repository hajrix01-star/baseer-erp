...
export const pageRegistry = [
  ...
  page({ id: "command-analytics", moduleId: "command", legacySection: 2, title: { ar: "التحليلات", en: "Analytics" }, icon: "chart", navigation: { order: 30, visible: true }, requiredPermissions: any(["finance.daily_sales.read", "finance.daily_sales.history.read_all"]) }),
  page({ id: "command-owner-notebook", moduleId: "command", legacySection: 3, title: { ar: "دفتر المالك اليومي", en: "Owner daily notebook" }, icon: "ledger", navigation: { order: 40, visible: true }, requiredPermissions: any(["inbound_evidence.owner_access"]) }),
  ...
  page({ id: "marketing-calendar", moduleId: "marketing", legacySection: 1, title: { ar: "التقويم التسويقي", en: "Marketing calendar" }, icon: "target", navigation: { order: 20, visible: true }, requiredPermissions: any(["marketing.insights.read"]) }),
  page({ id: "marketing-campaigns", moduleId: "marketing", legacySection: 2, title: { ar: "الحملات والعروض", en: "Campaigns & offers" }, icon: "activity", navigation: { order: 30, visible: true }, requiredPermissions: any(["marketing.insights.read", "marketing.campaign.write"]) }),
  page({ id: "marketing-reputation", moduleId: "marketing", legacySection: 3, title: { ar: "السمعة وGoogle", en: "Reputation & Google" }, icon: "shield", navigation: { order: 40, visible: true }, requiredPermissions: any(["marketing.insights.read", "marketing.google-business.profile.read"]) }),
  page({ id: "marketing-sources-policies", moduleId: "marketing", legacySection: 4, title: { ar: "المصادر والسياسات", en: "Sources & policies" }, icon: "shield", navigation: { order: 50, visible: true }, requiredPermissions: any(["marketing.insights.read"]) }),
  ...
  page({ id: "operations-catalog", moduleId: "operations", legacySection: 5, title: { ar: "المخزون والمستودعات", en: "Inventory & warehouses" }, icon: "clipboard", navigation: { order: 60, visible: true }, requiredPermissions: any(["operations.catalog.manage"]) }),
  page({ id: "operations-execution", moduleId: "operations", legacySection: 6, title: { ar: "طلبات المشتريات والعهدة", en: "Purchase requests & custody" }, icon: "receipt", navigation: { order: 70, visible: true }, requiredPermissions: any(["operations.catalog.manage"]) }),
  page({ id: "operations-internal-registration", moduleId: "operations", legacySection: 7, title: { ar: "التسجيل الداخلي", en: "Internal registration" }, icon: "clipboard", navigation: { order: 80, visible: true }, requiredPermissions: any(["operations.internal_registration.create", "operations.internal_registration.read"]) }),
  page({ id: "operations-reports", moduleId: "operations", legacySection: 8, title: { ar: "تقارير العمليات", en: "Operations reports" }, icon: "chart", navigation: { order: 90, visible: true }, requiredPermissions: any(["operations.catalog.manage", "operations.purchase_request.read", "operations.custody.read"]) }),
  ...
  page({ id: "administration-identity-basira", moduleId: "administration", legacySection: 4, title: { ar: "الهوية والثيم وبصيرة", en: "Identity, theme & Basira" }, icon: "palette", navigation: { order: 50, visible: true }, requiredPermissions: any(["platform.ai.configuration.read", "platform.ai.identity.read", "platform.ai.system_identity.read"]) }),
