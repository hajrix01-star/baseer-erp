...
export const updateAdministrationCompany = (session: ActiveSession, companyId: string, body: { nameAr: string; nameEn: string; businessTimezone: string; logoFileMetadataId: string | null; contextLocationCode: string | null; contextLocationLabelAr: string | null; contextLatitude: number | null; contextLongitude: number | null }) => api(session, `/administration/companies/${companyId}/settings`, { method: "PUT", headers: jsonHeaders(), body: JSON.stringify(body) });
