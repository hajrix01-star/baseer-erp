...
async function openFinanceReportsFixture(page: Page) {
  ...
  await page.route("**/v1/**", async (route) => {
    ...
    if (path === "/v1/finance/treasury") return fulfill(route, {
      ...
      vaults: [{ id: "vault-1", nameAr: "الصندوق الرئيسي", nameEn: "Main cash", type: "CASH", paymentMethods: ["CASH"], status: "ACTIVE", isSalesChannel: true, isPaymentDestination: true, sortOrder: 1, openingBalance: "0.00", balanceAsOf: "1250.00", inflow: "1250.00", outflow: "0.00" }],
    });
    if (path === "/v1/finance/treasury/vault-1/activity") return fulfill(route, { vault: { id: "vault-1", nameAr: "الصندوق الرئيسي", nameEn: "Main cash", type: "CASH", paymentMethods: ["CASH"], status: "ACTIVE", isSalesChannel: true, isPaymentDestination: true, sortOrder: 1, openingBalance: "0.00", balanceAsOf: "1250.00", inflow: "1250.00", outflow: "0.00" }, asOfBusinessDate: "2026-08-31", summary: { openingBalance: "0.00", balanceAsOf: "1250.00", inflow: "1250.00", outflow: "0.00" }, nextCursor: null, items: [{ id: "activity-1", journalEntryId: "journal-1", businessDate: "2026-08-15", sourceType: "DAILY_SALES", sourceReference: "SAL-2026-0001", description: "عينة", counterpartNameAr: null, counterpartNameEn: null, inflow: "1250.00", outflow: "0.00" }] });
