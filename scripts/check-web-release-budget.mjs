...
const limits = { initialJs: 250_000, largestJourneyJs: 85_000, initialCss: 58_000, largestJourneyCss: 16_000, comboboxLazyJs: 200_000, datePickerLazyJs: 200_000 };
const sizes = { initialJs, largestJourneyJs: largestJourney.js, initialCss: cssSize(startupKeys), largestJourneyCss: largestCssJourney.css, comboboxLazyJs, datePickerLazyJs };
