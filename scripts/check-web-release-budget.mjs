...
// CSS is measured as the full shared application stylesheet; 58 KB funds the calendar-style shared period picker and leaves explicit headroom for central primitives, not per-page CSS.
const limits = { js: 300_000, css: 58_000 };
