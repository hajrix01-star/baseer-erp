...
console.log("Marketing & Reputation Gate A1 guard passed: company scope, RLS, idempotency/audit, reply-policy control, no provider egress, honest readiness, central RHF/Zod forms.");
