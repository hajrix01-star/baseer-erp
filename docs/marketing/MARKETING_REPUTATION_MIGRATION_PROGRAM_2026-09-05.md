...
### MKT-02B — اكتشاف واختيار مورد ARZ صراحةً

يوثق العقد في `docs/marketing/GOOGLE_BUSINESS_ARZ_SELECTION_PILOT_2026-09-06.md`.
تسمح الشريحة فقط بعرض حسابات ومواقع Google Business من تفويض ARZ الخادمي ثم حفظ
اختيار حساب وموقع واحد بعد تأكيد المسؤول. لا cache لنتائج Google ولا مزامنة أو
مراجعات أو أداء أو نشر أو رد آلي أو Ads أو المعلم الشامي. تفعيل الشركة الثانية قرار
منفصل يعيد التفويض والاختيار والدليل ولا ينسخ token أو mapping.
