...
- **Scope:** `.github/workflows/verify.yml`, `apps/web/playwright.config.ts`, browser-acceptance fixtures, deployable runtime dependency lock resolution, and the root-level authentication verification launcher.
