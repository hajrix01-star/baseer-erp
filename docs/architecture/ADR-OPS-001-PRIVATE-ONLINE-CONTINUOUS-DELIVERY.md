...
- تظل حافتا HTTP/HTTPS العامتان `80/443` ملكاً للـproxy المشترك في Hostinger.
  Caddy الخاص بـBaseer يستمع فقط على `127.0.0.1:18080` كما في الإصدار الحي
  السابق؛ لذلك لا يزاحم تطبيقات VPS الأخرى ولا يكسر TLS المشترك.
