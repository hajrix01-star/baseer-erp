...
| P2 | primitives غير المركبة في اختبار العينة: `baseer-batch-panel` و`baseer-stepper__panel` وworkspace tabs وperiod/date popovers | CSS الحديث يعرّف لها variants، لكن fixture الهندسة الحالية لا يركبها. | وسّع fixture primitives بعناصر حقيقية لهذه classes، وافحص radius/padding/gap وقيود عرض popover في RTL والجوال. |
