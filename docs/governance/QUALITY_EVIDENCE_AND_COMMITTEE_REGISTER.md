...
| --- | --- | --- | --- | --- |
| 2026-08-23 | Marketing & Reputation — Gate A1 planning and implementation | **Active — internal foundation only** | [Foundation decision](../marketing/MARKETING_REPUTATION_FOUNDATION_DECISION_2026-08-23.md); committee review by architecture, measurement, provider-governance and assistant-UX roles. The scope is a company-scoped campaign register plus honest `NOT_CONNECTED` provider readiness. | Contracts/API/RLS/audit/UI acceptance remains open. Google Ads, Google Business, credentials, provider content, publishing, financial association and AI are explicitly outside A1 and require independent gates. |
