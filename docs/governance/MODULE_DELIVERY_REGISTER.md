...
| Field | Value |
| --- | --- |
| Active work | **Baseer UI Platform Enablement — completed baseline with two bounded React Aria HR pilots** is the sole active cross-cutting scope. Finance local acceptance remains closed; Reports/Operations candidates remain separate. |
...
| Next decision gate | مراقب الجودة يقرر Pilot نموذج غير مالي بـRHF/Zod أو يعيده؛ الإنتاج وNoorix والتقارير الرسمية تبقى بوابات منفصلة. |
