...
| Field | Value |
| --- | --- |
| Active work | **Decision Intelligence — library-migration closure** is the next module in the approved centralized sequence. Operations, HR, Finance, Administration and Reports migrations are closed locally. UI Platform Enablement remains an ongoing cross-cutting authority, not a competing business scope. |
| Open owner acceptance | No Operations, HR, Finance, Administration or Reports library-migration acceptance remains. Production, Noorix, formal reporting and decision-policy acceptance keep their independent gates. |
| Next decision gate | جرد مركز القرار من الـmanifest، وتصنيف كل نموذج وجدول واستعلام ومؤشر ورسم، ثم تحويل المستهلكين الحاليين عبر المحولات المركزية مع MetricContract/source/as-of وHTTP/RLS/browser evidence قبل الانتقال إلى Command Center. |
...
| Decision Intelligence | **Active — library-migration closure** | Existing context, timeline, alerts, evidence and metric consumers remain available for the active migration. | Complete instance-level inventory, MetricContract/source/as-of ownership, query/chart/form decisions, HTTP/RLS/browser and budget closure. |
| Command Center | Sequenced after Decision Intelligence | Existing command-center consumers remain available but are not the active migration scope. | Separate inventory, KPI/action ownership, browser and budget closure after Decision Intelligence. |
