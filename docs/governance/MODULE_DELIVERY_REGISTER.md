...
| Field | Value |
| --- | --- |
| Active work | **Baseer UI Platform Enablement — completed baseline with bounded React Aria, RHF/Zod, Query and ECharts HR pilots** is the sole active cross-cutting scope. Finance local acceptance remains closed; Reports/Operations candidates remain separate. |
