...
- تبدأ حقول إدخال الأرقام فارغة دائماً؛ لا تستخدم `0` قيمة ابتدائية أو placeholder. الصفر قيمة يدخلها المستخدم صراحةً فقط، ولا يتحول الحقل الفارغ إلى صفر في العميل أو الخادم.
